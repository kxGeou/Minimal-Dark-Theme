  ...
  return (
    <header className='flex flex-col justify-center items-center text-center mt-[4rem]'>
        <div className='mb-[6rem] space-y-2'>
            <h2 className='text-[2.5rem] text-[#7887FF] font-semibold'>Minimalist Dark Theme</h2>
            <p className='text-[1.25rem] text-white/30 font-light'>Minimal dark theme, perfect for late coding sessions</p>
        </div>
